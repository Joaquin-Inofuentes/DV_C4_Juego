...
public class MA_P2_ST_C_C4 : MonoBehaviour, MA_P2_ST_C_IWeapon
{

    [Header("Identidad")]
    [SerializeField] public string nombre = "C4";
    [SerializeField] public string tipoMunicion = "Detonador";

    [Header("Stats")]
    [SerializeField] public int daño = 100;
    ...
    [SerializeField] public int municionTotal = 3;
