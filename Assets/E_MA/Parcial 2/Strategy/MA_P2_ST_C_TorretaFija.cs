...
public class MA_P2_ST_C_TorretaFija : MonoBehaviour, MA_P2_ST_C_IWeapon
{
    [Header("Identidad")]
    [SerializeField] public string nombre = "TorretaFija";
    [SerializeField] public string tipoMunicion = "BalasPesadas";

    [Header("Stats")]
    [SerializeField] public int daño = 20;
    [SerializeField] public float rateDisparo = 3f;
    [SerializeField] public float rateRecarga = 2f;
    [SerializeField] public float speedShot = 20f;

    [Header("Munición")]
    [SerializeField] public int capacidadCargador = 10;
    [SerializeField] public int balasActuales = 10;
    [SerializeField] public int municionTotal = 50;
